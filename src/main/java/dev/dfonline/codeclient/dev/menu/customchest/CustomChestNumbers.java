...
public class CustomChestNumbers {
    public static final CustomChestNumbers SMALL = new CustomChestNumbers(
            Identifier.of(CodeClient.MOD_ID, "textures/gui/container/custom_chest/background.png"),
            176,
            216,
            202,
            229,
    ...
    public static final CustomChestNumbers LARGE = new CustomChestNumbers(
            Identifier.of(CodeClient.MOD_ID, "textures/gui/container/custom_chest/background_big.png"),
            198,
            294,
            228,
            294,
